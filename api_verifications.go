...
Download verification results as a COMPRESSIONFORMAT_ZIP file. Required Access Level: ViewVerifyEmails
...
Uploads a EXPORTFILEFORMATS_CSV file with list of emails that can then be triggered for verification. An 'email' column is required. Required Access Level: VerifyEmails
